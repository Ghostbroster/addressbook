...
public class TaskForm extends FormLayout {
    ...
    TextField taskDescription = new TextField("Task");
    ...
    private void buildLayout() {
        ...
        addComponents(actions, firstName, lastName, phone, email, startDate, expectedEndDate, taskDescription);
    }
    ...
    public void save(Button.ClickEvent event) {
        try {
            ...
            String msg = String.format("Saved '%s %s'.", task.getFirstName(), task.getLastName());
    ...
    void edit(Task task) {
        ...
        if (task != null) {
            ...
            formFieldBindings = BeanFieldGroup.bindFieldsBuffered(task, this);
            firstName.focus();
        }
    ...
    @Override
    public ToDoTasksUI getUI() {
        return (ToDoTasksUI) super.getUI();
    }
